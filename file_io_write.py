...
myfile = open('io-files/write-file.txt', mode='at', newline=None) # call function to create file
...
with open('io-files/write-file.txt', mode='at', newline=None)  as anotherFile :
